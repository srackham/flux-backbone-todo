...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flux = _interopRequire(__webpack_require__(1));
	
	var Backbone = _interopRequire(__webpack_require__(4));
	
	var getLocalStorageSync = _interopRequire(__webpack_require__(3));
	...
	var TodoStore = Backbone.Collection.extend({
	  ...
	  initialize: function initialize(models, options) {
	    ...
	    this.on("sync", function (model, resp) {
	      return console.log("SUCCESS: sync response:", resp);
	    });
	    this.on("error", function (model, resp) {
	      return console.log("ERROR: sync error:", resp);
	    });
	...
	var TodoFormComponent = React.createClass({
	  ...
	  handleClearTodos: function handleClearTodos() {
	...
	var TodoListComponent = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.props.store.on("add remove reset", this.forceUpdate.bind(this, null));
	  },
	...
	var TodoItemComponent = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.props.todoItem.on("change", this.forceUpdate.bind(this, null));
	  },
	  ...
	  handleToggleTodo: function handleToggleTodo() {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "span",
	      { style: style, onClick: this.handleToggleTodo },
	...
	React.render(React.createElement(
	  ...
	  React.createElement(TodoFormComponent, { store: todoStore }),
	  React.createElement(TodoListComponent, { store: todoStore }),
	  React.createElement(
	    "p",
	    null,
	    "Want a second fully synchronized list? Just declare another list component: no code required, no events to wire up!"
	  ),
	  React.createElement(TodoListComponent, { store: todoStore })
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(33), __webpack_require__(32), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
