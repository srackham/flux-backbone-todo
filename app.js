...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = _interopRequire(__webpack_require__(3));
	
	var getLocalStorageSync = _interopRequire(__webpack_require__(4));
	  ...
	  render: function () {
	    var items = this.props.store.map(function (todoItem) {
	      return React.createElement("li", {
	        key: todoItem.cid
	      }, React.createElement(TodoItemComponent, {
	        todoItem: todoItem
	      }));
	    });
	...
	React.render(React.createElement("div", null, React.createElement("h3", null, "Todos"), React.createElement(TodoFormComponent, {
	  store: todoStore
	}), React.createElement(TodoListComponent, {
	  store: todoStore
	}), React.createElement("p", null, "Want a second fully synchronized list? Just declare another list component: no code required,", "no events to wire up!"), React.createElement(TodoListComponent, {
	  store: todoStore
